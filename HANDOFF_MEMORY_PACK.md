...
- ⬜ NEXT STEPS (in order):
  ...
  10. REMAINING SESSIONS: Session 3 "SHARPER" (staged progress, Fast/Thorough toggle, caching, history, keyword cleanup, mobile @media, empty state), Session 4 "STOREFRONT" (LICENSE MIT, transformers<5 pin in README, auto-pick docs, remove HF frontmatter, page title), Session 5 "ENSEMBLE LIVE" (HHEM ONNX on Streamlit Cloud).
