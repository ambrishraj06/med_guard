...
- ⬜ NEXT STEPS (in order):
  ...
  12. REMAINING SESSIONS: Session 4 "STOREFRONT" (LICENSE MIT, transformers<5 pin in README, auto-pick docs, remove HF frontmatter, page title alignment), Session 5 "ENSEMBLE LIVE" (HHEM ONNX on Streamlit Cloud).
