...
- ⬜ NEXT STEPS (in order):
  ...
  5. REMAINING: user manual click-through of question-only + warfarin-style case in real browser (automation can't commit Streamlit text-area edits). Then optional: tiny NLI third checker, Oracle ARM hosting (unlocks MiniCheck + 24/7), eval set with precision/recall, FastAPI endpoint, phase-2 demo RAG bot.
